        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Create Request Boost</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Create Boost</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
            ...
            <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button
                        ...
                        <span class="d-none d-md-block">Create Boost</span>
                    </button>
                </li>
            </ul>
            <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="card w-100 position-relative overflow-hidden mb-0">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-subtitle mb-4">Save the boost request details here</p>
                                        <form id="boostForm" method="POST" enctype="multipart/form-data"
                                            action="{{ route('system.request.boosts.store') }}">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="number" class="form-control" id="qty"
                                                            name="qty" placeholder="Enter Quantity" min="1">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="invalid-feedback">Please select a social media platform.
                                                        </div>
                                                    </div>

                                                    <div class="mb-4">
                                                        <label for="social_media_platform_limit_id"
                                                            class="form-label fw-semibold">Boosting Limit</label>
                                                        <select name="social_media_platform_limit_id"
                                                            id="social_media_platform_limit_id" class="form-control">
                                                            <option value="">Select Boosting Limit</option>
                                                            <!-- Boosting limits will be dynamically filled -->
                                                        </select>
                                                        <div class="invalid-feedback">Please select a boosting limit.</div>
                                                    </div>

                                                    <script>
                                                        document.getElementById('social_media_platform_id').addEventListener('change', async function() {
                                                            var platformId = this.value;
                                                            var limitSelect = document.getElementById('social_media_platform_limit_id');
                                                            
                                                            // Kosongkan pilihan sebelum memuat yang baru
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-4">
                                                        <label for="content"
                                                            class="form-label fw-semibold">Notes</label>
                                                        <textarea name="content" rows="4" class="form-control" id=""></textarea>
                                                        <div class="invalid-feedback">Content is required.</div>
                                                    </div>
                                                </div>

                                                <div class="col-lg-6">
                                                    <div class="mb-4" id="comment_section" style="display: none;">
