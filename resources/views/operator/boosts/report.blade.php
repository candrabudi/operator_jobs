        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Report Boost</h4>
            ...
            <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button
                        ...
                        <span class="d-none d-md-block">Report Boost</span>
                    </button>
                </li>
            </ul>
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-account" role="tabpanel"
                            ...
                            <div class="col-12">
                                <div class="card w-100 position-relative overflow-hidden mb-0">
                                    <div class="card-body p-4">
                                        <h5 class="card-title fw-semibold">Report Boost </h5>
                                        <p class="card-subtitle mb-4">save the Boost report here</p>
                                        @if ($existingReport)
                                            <div class="alert alert-info">
                                                Report already exists. You can view or edit the report below.
                                            </div>
                                            <form method="POST" enctype="multipart/form-data"
                                                action="{{ route('system.operator.request.boosts.update', $existingReport->id) }}">
                                                @csrf
                                                @method('PUT')
                                                <input type="hidden" name="request_boost_id"
                                                    value="{{ $requestBoostID }}">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-4">
                        ...
                        `;
                                        ...
                                        @else
                                            <form method="POST" enctype="multipart/form-data"
                                                action="{{ route('system.operator.request.boosts.store') }}">
                                                @csrf
                                                <input type="hidden" name="request_boost_id"
                                                    value="{{ $requestBoostID }}">
                                                <div class="row">
